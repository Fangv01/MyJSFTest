...
public class BidBean1 {
	...
	public void setNumericBidAmount(double numericBidAmount) {
	...
	public void setBidDuration(String bidDuration) {
		...
		try {
			setNumericBidDuration(Integer.parseInt(bidDuration));
		}catch (NumberFormatException nfe) {}
	}
	public int getNumericBidDuration() {
		return numericBidDuration;
	}
	public void setNumericBidDuration(int numericBidDuration) {
	...
	public String doBid() {
		...
		if (getNumericBidDuration() <15) {
			context.addMessage(null, new FacesMessage("Duration must be at least 15 days."));
		}
